...
CANADADATA<- read.csv("https://github.com/ishaberry/Covid19Canada/raw/master/timeseries_hr/cases_timeseries_hr.csv",encoding="UTF-8")
...
geomCAN = st_read("CanadaRegionalHealthBoundaries.geojson")
...
HAM$RegionName = paste0(HAM$health_region,", ",HAM$province)


CANADA_DATA = subset(HAM,select = c("DateReport","RegionName","pInf","geometry"))
